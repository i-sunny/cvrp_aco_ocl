...
class Move {
public:
    Move(AntStruct *ant_, bool valid_, float gain_, int pos_n1_, int pos_n2_, MoveType type_)
...
public:
    ExchangeMove(AntStruct *ant_, bool valid_, float gain_, int pos_n1_, int pos_n2_,
...
public:
    InsertionMove(AntStruct *ant_, bool valid_, float gain_, int pos_n1_, int pos_n2_,
                 int load_r1_, int load_r2_)
...
public:
    InversionMove(AntStruct *ant_, bool valid_, float gain_, int pos_n1_, int pos_n2_)
